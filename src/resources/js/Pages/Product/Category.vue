<template>
    <Head :title="category_details.category_name" />
    <div class="container mx-auto">
        <div class="md:flex md:justify-between">
            <div class="w-full md:w-9/12 md:mr-5 pt-4">
                <h1 class="text-2xl">
                    {{ category_details.category_name }}
                    <span class="text-sm">({{ products.total }} Products)</span>
                </h1>
                <hr />
                <br />
                ...
                <div class="mt-8 grid lg:grid-cols-3 gap-10">
                    <div
                        ...
                        v-for="(productDetails, productKey) in products.data"
                        :key="productKey"
                    >
                        <Link
                            :href="
                                '/' +
                                category_details.category_slug +
                                '/' +
                                productDetails.slug
                            "
                        >
                        ...
                        <div class="p-5">
                            ...
                            <div class="flex justify-between mt-5">
                                <p
                                    class="mb-3 font-normal text-green-700 dark:text-green-700 font-bold"
                                >
                            ...
                            <div class="mt-5">
                                <Link
                                    :href="
                                        ...
                                        productDetails.slug
                                    "
                                    class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-orange-700 rounded-lg"
                                >
                                    Read more
                                    <svg
                                        aria-hidden="true"
